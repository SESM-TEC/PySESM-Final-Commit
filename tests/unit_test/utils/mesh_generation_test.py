...
def test_generate_mesh_samples():
    """
    Test the generate_mesh function for correct mesh generation
    ...
    xx, yy, zz = generate_mesh_samples(n_points, xl, xr, sigma, mu)
    ...
    xx_small, yy_small, zz_small = generate_mesh_samples(10, -1.0, 1.0, sigma, mu)
    ...
    xx_large, yy_large, zz_large = generate_mesh_samples(1000, -10.0, 10.0, sigma, mu)
...
def test_generate_random_samples():
    """
    Test the generate_random_samples function for correct random
    sample generation and density evaluation.
    """
    n_points = 100
    xl, xr = -3.0, 3.0
    SEED = 42

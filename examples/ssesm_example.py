...
Demonstrates the Sequential Sparse-Encoded Surrogate Model (SSESM) training
workflow, including configuration serialization and visualization hooks.
...
dict_config = GaussianDictConfig(
    ...
    optimizer_factory=lambda params, lr: torch.optim.AdamW(
        params, lr=lr, weight_decay=0.005315
    ),

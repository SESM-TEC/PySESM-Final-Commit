...
Concrete tests for the ISTALayer, verifying initialization strategies, update
logic, and convergence on synthetic Gaussian data.
...
class TestISTALayer(BaseSparseCodingTest):
    ...
    def test_ista_perfect_dictionary(self):
    ...
    def test_ista_sparse_selection(self):

"""
Gaussian Dictionary Layer Tests.

Unit tests for the GaussianDictLayer, verifying parameter initialization,
forward pass correctness, and gradient flow for split training strategies.

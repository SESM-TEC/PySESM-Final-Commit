"""
Sparse Coding Base Tests.

Abstract base test class defining common verification logic for all sparse
coding layers (parameter initialization, hook execution, device placement).

"""Experimentos ICICT: runner principal.

Este script ejecuta un conjunto de experimentos sobre funciones de prueba
multidimensionales usando los modelos disponibles (SESM, SVR, NN, PF).

Uso: ejecutar desde el directorio del experimento:
    python main.py

Guarda checkpoints en `./checkpoints` y resultados en `./plots`.
"""
...
# pysesm imports (project package)
...
def load_checkpoint(checkpoint_dir="./checkpoints"):
    ...
    if os.path.exists(checkpoint_path):
        ...
        logger.debug("Checkpoint cargado. Progreso: %d combinaciones completadas.",
                     len(checkpoint['progress_tracker'])
                     )

...
Provides helper functions for matrix operations, such as converting vectors to
triangular matrices, Gram-Schmidt orthogonalization, and other linear algebra
routines needed by the dictionary layers.
